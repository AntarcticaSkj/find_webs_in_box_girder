...
private:
  ...
  std::optional<ros::Publisher> output_topic_pub;   /**< Multiplexed command velocity topic */
  std::string    output_topic_name;                 /**< Multiplexed command velocity topic name */
  std::optional<ros::Publisher> active_subscriber;  /**< Currently allowed cmd_vel subscriber */
