...
public:
    ...
    // RE ---------------------------------------
    // void rebuild_all_and_remove_knn_not_match();
    // bool isremoveDone()
    // {
    //     return removeDone;
    // }
    bool remove_knn_not_match = false;
    void setMapToUpdate(PointVector* _MapToUpdate)
    {
        MapToUpdate = _MapToUpdate;
    }
    void updateMap();
    void updateMapPer(KD_TREE_NODE **root, PointVector& point_cloud);
    // RE ---------------------------------------
    ...
    // RE ---------------------------------------
    // void flatten2(KD_TREE_NODE *root, PointVector &Storage, delete_point_storage_set storage_type);
    // RE ---------------------------------------
